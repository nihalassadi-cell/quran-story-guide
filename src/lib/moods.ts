...
const SUBHANALLAH_BIHAMDIH: Kalima = {
  ...
  translation: {
    ...
    ru: "Слава Аллаху и хвала Ему; слава Аллаху Великому.",
  ...
  why: {
    ...
    ru: "Когда сердцу нужна опора — вернись к двум словам, которые Пророк ﷺ назвал самыми тяжёлыми на весах.",
...
const HASBIYALLAH: Kalima = {
  ...
  translation: {
    ...
    ru: "Аллах мне достаточен — нет божества, кроме Него. На Него я уповаю, и Он — Господь великого Трона.",
  ...
  why: {
    ...
    ru: "Когда чувствуешь одиночество или подавленность, Пророк ﷺ учил: повтори семь раз — Аллаха достаточно.",
...
const ISTIGHFAR: Kalima = {
  ...
  translation: {
    ...
    ru: "Прошу у Аллаха прощения и обращаюсь к Нему с покаянием.",
  ...
  why: {
    ...
    ru: "Абу Давуд 1518: «Кто будет постоянен в истигфаре — Аллах сделает ему выход из любой скорби».",
...
const LA_HAWLA: Kalima = {
  ...
  translation: {
    ...
    ru: "Нет силы и мощи, кроме как у Аллаха.",
  ...
  why: {
    ...
    ru: "Передай тяжесть Тому, Кто несёт её на самом деле. Ибн аль-Каййим: лекарство от девяноста девяти болезней — самой лёгкой из которых является печаль.",
...
const YA_HAYYU: Kalima = {
  ...
  translation: {
    ...
    ru: "О Живой, О Самосущий — Твоей милостью молю об облегчении.",
  ...
  why: {
    ...
    ru: "Когда горе больше слов: два Его имени и одна нужда — Его милость.",
...
const HASBUNALLAH: Kalima = {
  ...
  translation: {
    ...
    ru: "Достаточно нам Аллаха, Он — лучший Покровитель.",
  ...
  why: {
    ...
    ru: "Слова, сказанные в пламени и на поле битвы — они не сгорели и не проиграли. Возьми их себе.",
...
const YUNUS_DUA: Kalima = {
  ...
  why: {
    ...
    ru: "«Никто из мусульман, обращающийся к Аллаху этими словами о чём-либо, не остаётся без ответа».",
...
const TAHLIL: Kalima = {
  ...
  translation: {
    ...
    ru: "Нет божества, кроме Аллаха, Единого, у Которого нет сотоварища. Ему принадлежит власть и хвала, и Он надо всем мощен.",
  ...
  why: {
    ...
    ru: "Фраза, в которой всё. Надежда строится на истине о Том, в Чьей руке вся вселенная.",
...
const TAAWUDH: Kalima = {
  ...
  why: {
    ...
    ru: "Гнев — это жар шайтана в твоей груди. Назови источник, назови лекарство — скажи это, сядь, выпей воды.",
...
const ALHAMDU_NIMAH: Kalima = {
  ...
  translation: {
    ...
    ru: "Вся хвала Аллаху, по милости Которого завершаются все блага.",
  ...
  why: {
    ...
    ru: "Благодарность сама — это дверь: «Если будете благодарны, Я непременно умножу для вас» (Коран 14:7).",
...
const TASBIH_FATIMI_TASBIH: Kalima = {
  ...
  why: {
    ...
    ru: "Когда язык и сердце устали, даже самое лёгкое прославление склоняет чашу весов.",
...
const TAHMID: Kalima = {
  ...
  translation: {
    ...
    ru: "Вся хвала принадлежит Аллаху.",
  ...
  why: {
    ...
    ru: "Одно слово, которое наполняет весы и меняет весь день.",
...
const TAKBIR: Kalima = {
  ...
  why: {
    ...
    ru: "Что бы тебя ни тревожило — Он больше этого. Повторяй, пока сердце не услышит.",
...
const SALAWAT: Kalima = {
  ...
  translation: {
    ...
    ru: "О Аллах, благослови Мухаммада ﷺ и род Мухаммада.",
  ...
  why: {
    ...
    ru: "Когда сердце тяжело — посылай благословения на того, кто был послан как милость, и милость возвращается умноженной.",
...
const BISMILLAH_LA_YADURR: Kalima = {
  ...
  translation: {
    ...
    ru: "С именем Аллаха, с именем Которого ничто на земле и на небе не может навредить, и Он — Слышащий, Знающий.",
  ...
  why: {
    ...
    ru: "Трижды — крепость от вреда явного и скрытого.",
...
export const MOODS: Mood[] = ([
  {
    ...
    blurb: {
      ...
      ru: "Когда ноша кажется тяжелее твоих сил.",
  ...
  },
  {
    ...
    blurb: {
      ...
      ru: "Когда страх перед завтрашним днём не отступает.",
  ...
  },
  {
    ...
    blurb: {
      ...
      ur: "جب دل بھاری ہو۔", ru: "Когда сердце тяжело.", bn: "যখন হৃদয় ভারী।",
    ...
    verses: [
      { surah: 93, verse: 3, surahName: "Ad-Duha", reason: L("“Your Lord has not forsaken you, nor become displeased.”", { ur: "”تمہارے رب نے نہ تمہیں چھوڑا اور نہ ناراض ہوا۔“", ru: "«Твой Господь не покинул тебя и не возненавидел».", bn: "“তোমার রব তোমাকে ত্যাগ করেননি, অসন্তুষ্টও হননি।”", fa: "«پروردگارت تو را رها نکرده و خشم نگرفته است.»", id: "“Tuhanmu tidak meninggalkanmu dan tidak pula benci kepadamu.”", ms: "“Tuhanmu tidak meninggalkanmu dan tidak pula membenci kamu.”", tr: "“Rabbin seni terk etmedi ve sana darılmadı.”", fr: "« Ton Seigneur ne t'a point abandonné, ni détesté. »", de: "„Dein Herr hat dich weder verlassen noch verabscheut.“" }) },
      { surah: 93, verse: 5, surahName: "Ad-Duha", reason: L("“Your Lord will give to you, and you will be satisfied.”", { ur: "”تمہارا رب تمہیں اتنا دے گا کہ تم راضی ہو جاؤ گے۔“", ru: "«Господь твой одарит тебя, и ты будешь доволен».", bn: "“তোমার রব তোমাকে এত দেবেন যে তুমি সন্তুষ্ট হবে।”", fa: "«پروردگارت چنان به تو خواهد بخشید که خشنود شوی.»", id: "“Tuhanmu akan memberimu, sehingga engkau ridha.”", ms: "“Tuhanmu akan memberi kepadamu, lalu engkau berpuas hati.”", tr: "“Rabbin sana verecek ve sen razı olacaksın.”", fr: "« Ton Seigneur t'accordera et tu seras satisfait. »", de: "„Dein Herr wird dir geben, und du wirst zufrieden sein.“" }) },
      { surah: 39, verse: 53, surahName: "Az-Zumar", reason: L("“Do not despair of the mercy of Allah.”", { ur: "”اللہ کی رحمت سے مایوس نہ ہو۔“", ru: "«Не отчаивайтесь в милости Аллаха».", bn: "“আল্লাহর রহমত থেকে নিরাশ হয়ো না।”", fa: "«از رحمت خدا نومید نشوید.»", id: "“Janganlah berputus asa dari rahmat Allah.”", ms: "“Janganlah kamu berputus asa dari rahmat Allah.”", tr: "“Allah'ın rahmetinden ümit kesmeyin.”", fr: "« Ne désespérez pas de la miséricorde d'Allah. »", de: "„Verzweifelt nicht an der Barmherzigkeit Allahs.“" }) },
      { surah: 12, verse: 86, surahName: "Yusuf", reason: L("Yaqub ﷺ: “I only complain of my suffering and grief to Allah.”", { ur: "یعقوب ﷺ: ”میں اپنی پریشانی اور غم صرف اللہ سے کہتا ہوں۔“", ru: "Йакуб ﷺ: «Я жалуюсь на свою скорбь и печаль только Аллаху».", bn: "ইয়াকূব ﷺ: “আমি আমার দুঃখ ও কষ্ট কেবল আল্লাহর কাছে জানাই।”", fa: "یعقوب ﷺ: «من اندوه و درد خویش را تنها به خدا می‌گویم.»", id: "Ya'qub ﷺ: “Sesungguhnya aku adukan kesedihan dan keluh kesahku hanya kepada Allah.”", ms: "Yaakub ﷺ: “Aku adukan kesedihan dan dukacitaku hanya kepada Allah.”", tr: "Yakub ﷺ: “Ben kederimi ve üzüntümü yalnız Allah'a şikâyet ediyorum.”", fr: "Ya'qub ﷺ : « Je ne me plains qu'à Allah de ma douleur et de ma tristesse. »", de: "Ya'qub ﷺ: „Ich klage meinen Kummer und meine Trauer allein bei Allah.“" }) },
      { surah: 65, verse: 7, surahName: "At-Talaq", reason: L("“Allah will bring about, after hardship, ease.”", { ur: "”اللہ تنگی کے بعد آسانی پیدا فرما دے گا۔“", ru: "«Аллах после тяготы дарует облегчение».", bn: "“আল্লাহ কষ্টের পর স্বস্তি দান করবেন।”", fa: "«خدا پس از سختی آسانی خواهد آورد.»", id: "“Allah akan memberikan kemudahan setelah kesulitan.”", ms: "“Allah akan datangkan kemudahan selepas kesukaran.”", tr: "“Allah, güçlüğün ardından bir kolaylık verecektir.”", fr: "« Allah, après la gêne, apportera la facilité. »", de: "„Allah wird nach der Not Erleichterung schaffen.“" }) },
    ],
  },
  {
    id: "angry",
    ...
    blurb: {
      ...
      ur: "جب سینے میں آگ بھڑک اٹھے۔", ru: "Когда в груди разгорается огонь.", bn: "যখন বুকের ভেতর আগুন জ্বলে ওঠে।",
  ...
  },
  {
    ...
    blurb: {
      ...
      ur: "جب لگے کہ کوئی نہیں ہے۔", ru: "Когда кажется, что рядом никого нет.", bn: "যখন মনে হয় কেউ পাশে নেই।",
    ...
    verses: [
      { surah: 50, verse: 16, surahName: "Qaf", reason: L("“We are closer to him than his jugular vein.”", { ur: "”ہم اس کی شہ رگ سے بھی زیادہ قریب ہیں۔“", ru: "«Мы ближе к нему, чем его яремная вена».", bn: "“আমরা তার গ্রীবাস্থ ধমনী থেকেও নিকটে।”", fa: "«ما به او از رگ گردنش نزدیک‌تریم.»", id: "“Kami lebih dekat kepadanya daripada urat lehernya.”", ms: "“Kami lebih dekat kepadanya daripada urat lehernya sendiri.”", tr: "“Biz ona şah damarından daha yakınız.”", fr: "« Nous sommes plus près de lui que sa veine jugulaire. »", de: "„Wir sind ihm näher als seine Halsschlagader.“" }) },
      { surah: 2, verse: 186, surahName: "Al-Baqarah", reason: L("“When My servants ask about Me — I am near.”", { ur: "”جب میرے بندے میرے بارے میں پوچھیں — میں قریب ہوں۔“", ru: "«Когда рабы Мои спросят обо Мне — Я близок».", bn: "“আমার বান্দারা আমার সম্পর্কে জিজ্ঞেস করলে — আমি নিকটেই আছি।”", fa: "«وقتی بندگانم درباره من بپرسند — من نزدیکم.»", id: "“Apabila hamba-Ku bertanya tentang-Ku — Aku dekat.”", ms: "“Apabila hamba-Ku bertanya tentang-Ku — Aku dekat.”", tr: "“Kullarım sana Beni sorduğunda — Ben yakınım.”", fr: "« Quand Mes serviteurs t'interrogent sur Moi — Je suis proche. »", de: "„Wenn Meine Diener nach Mir fragen — Ich bin nah.“" }) },
      { surah: 57, verse: 4, surahName: "Al-Hadid", reason: L("“He is with you wherever you are.”", { ur: "”تم جہاں کہیں بھی ہو، وہ تمہارے ساتھ ہے۔“", ru: "«Где бы вы ни были, Он с вами».", bn: "“তোমরা যেখানেই থাকো, তিনি তোমাদের সঙ্গে।”", fa: "«هر کجا باشید، او با شماست.»", id: "“Dia bersamamu di mana pun kamu berada.”", ms: "“Dia bersamamu di mana sahaja kamu berada.”", tr: "“Nerede olursanız olun, O sizinle beraberdir.”", fr: "« Il est avec vous où que vous soyez. »", de: "„Er ist mit euch, wo immer ihr seid.“" }) },
      { surah: 93, verse: 7, surahName: "Ad-Duha", reason: L("“He found you lost and guided you.”", { ur: "”اس نے تمہیں بھٹکا ہوا پایا اور راہ دکھائی۔“", ru: "«Он нашёл тебя заблудшим и наставил».", bn: "“তিনি তোমাকে পথহারা পেয়েছিলেন, এরপর পথ দেখিয়েছেন।”", fa: "«تو را گمراه یافت و هدایت کرد.»", id: "“Dia mendapatimu sebagai seorang yang bingung, lalu memberi petunjuk.”", ms: "“Dia mendapati kamu sesat lalu memberi petunjuk.”", tr: "“Seni şaşırmış buldu da yol gösterdi.”", fr: "« Il t'a trouvé égaré, et Il t'a guidé. »", de: "„Er fand dich umherirrend und leitete dich recht.“" }) },
      { surah: 12, verse: 86, surahName: "Yusuf", reason: L("Yaqub's grief carried to Allah alone — closeness.", { ur: "یعقوب کا غم صرف اللہ سے کہنا — قربت۔", ru: "Йакуб жалуется на скорбь только Аллаху — близость.", bn: "ইয়াকূবের দুঃখ কেবল আল্লাহকে জানানো — এক ধরনের নৈকট্য।", fa: "اندوه یعقوب فقط با خدا — همان نزدیکی است.", id: "Kesedihan Ya'qub yang hanya diadukan kepada Allah — itulah kedekatan.", ms: "Kesedihan Yaakub yang hanya diadukan kepada Allah — itulah kedekatan.", tr: "Yakub'un kederini yalnız Allah'a iletmesi — bir yakınlıktır.", fr: "La tristesse de Ya'qub portée à Allah seul — une proximité.", de: "Ya'qubs Kummer, allein Allah anvertraut — Nähe."}) },
    ],
  },
  {
    id: "grateful",
    ...
    blurb: {
      ...
      ur: "جب آپ اس کا شکر ادا کرنا چاہیں۔", ru: "Когда хочется поблагодарить Его.", bn: "যখন তাঁকে কৃতজ্ঞতা জানাতে চান।",
  ...
  },
  {
    ...
    blurb: {
      ...
      ur: "جب کچھ بہتر ممکن لگے۔", ru: "Когда возможно что-то лучшее.", bn: "যখন কিছু উত্তম সম্ভব মনে হয়।",
    ...
    verses: [
      { surah: 39, verse: 53, surahName: "Az-Zumar", reason: L("“Do not despair of the mercy of Allah.”", { ur: "”اللہ کی رحمت سے مایوس نہ ہو۔“", ru: "«Не отчаивайтесь в милости Аллаха».", bn: "“আল্লাহর রহমত থেকে নিরাশ হয়ো না।”", fa: "«از رحمت خدا نومید نشوید.»", id: "“Janganlah berputus asa dari rahmat Allah.”", ms: "“Janganlah kamu berputus asa dari rahmat Allah.”", tr: "“Allah'ın rahmetinden ümit kesmeyin.”", fr: "« Ne désespérez pas de la miséricorde d'Allah. »", de: "„Verzweifelt nicht an der Barmherzigkeit Allahs.“" }) },
      { surah: 65, verse: 3, surahName: "At-Talaq", reason: L("“Allah will accomplish His purpose.”", { ur: "”اللہ اپنا کام پورا کر کے رہتا ہے۔“", ru: "«Аллах непременно доводит Своё дело до конца».", bn: "“আল্লাহ তাঁর উদ্দেশ্য পূর্ণ করেন।”", fa: "«خدا کار خود را به انجام می‌رساند.»", id: "“Allah pasti melaksanakan urusan-Nya.”", ms: "“Allah pasti melaksanakan urusan-Nya.”", tr: "“Allah, emrini yerine getirir.”", fr: "« Allah accomplit Son décret. »", de: "„Allah führt Seinen Willen aus.“" }) },
      { surah: 94, verse: 5, surahName: "Ash-Sharh", reason: L("“With hardship comes ease.”", { ur: "”مشکل کے ساتھ آسانی ہے۔“", ru: "«Поистине, вместе с тягостью — облегчение».", bn: "“কষ্টের সাথে আছে স্বস্তি।”", fa: "«با هر سختی آسانی است.»", id: "“Bersama kesulitan ada kemudahan.”", ms: "“Bersama kesukaran ada kemudahan.”", tr: "“Güçlükle beraber kolaylık vardır.”", fr: "« Avec la difficulté est une facilité. »", de: "„Mit der Schwierigkeit kommt Erleichterung.“" }) },
      { surah: 12, verse: 87, surahName: "Yusuf", reason: L("“Only the disbelievers lose hope in the mercy of Allah.”", { ur: "”اللہ کی رحمت سے صرف کافر مایوس ہوتے ہیں۔“", ru: "«В милости Аллаха отчаиваются только неверующие».", bn: "“আল্লাহর রহমত থেকে কেবল কাফেররাই নিরাশ হয়।”", fa: "«جز کافران از رحمت خدا نومید نمی‌شوند.»", id: "“Tiada yang putus asa dari rahmat Allah kecuali orang kafir.”", ms: "“Tiada yang berputus asa dari rahmat Allah melainkan orang kafir.”", tr: "“Allah'ın rahmetinden ancak kâfirler ümit keser.”", fr: "« Seuls les mécréants désespèrent de la miséricorde d'Allah. »", de: "„Nur die Ungläubigen verzweifeln an Allahs Barmherzigkeit.“" }) },
      { surah: 2, verse: 216, surahName: "Al-Baqarah", reason: L("“You may dislike a thing that is good for you.”", { ur: "”ہو سکتا ہے تم کسی چیز کو ناپسند کرو اور وہ تمہارے لیے بہتر ہو۔“", ru: "«Может быть, вам неприятно нечто, а оно лучше для вас».", bn: "“তোমরা এমন কিছু অপছন্দ করো যা তোমাদের জন্য ভালো।”", fa: "«شاید چیزی را ناخوش دارید و آن برایتان نیکوست.»", id: "“Boleh jadi kamu membenci sesuatu padahal itu baik bagimu.”", ms: "“Boleh jadi kamu membenci sesuatu sedangkan ia baik untukmu.”", tr: "“Bir şeyden hoşlanmazsınız ama o sizin için hayırlıdır.”", fr: "« Il se peut que vous détestiez une chose alors qu'elle est un bien pour vous. »", de: "„Vielleicht ist euch etwas verhasst, doch es ist gut für euch.“" }) },
    ],
  },
  {
    id: "guilty",
    ...
    blurb: {
      ...
      ur: "جب لوٹنا چاہو۔", ru: "Когда хочется вернуться.", bn: "যখন ফিরে যেতে চান।",
  ...
  },
  {
    ...
    blurb: {
      ...
      ur: "جب کوئی چیز خوفزدہ کرے۔", ru: "Когда что-то пугает.", bn: "যখন কিছু তোমাকে ভয় দেখায়।",
    ...
    verses: [
      ...
      { surah: 2, verse: 255, surahName: "Al-Baqarah", reason: L("Ayat al-Kursi — divine sovereignty and protection.", { ur: "آیت الکرسی — اللہ کی حاکمیت اور حفاظت۔", ru: "Аят аль-Курси — владычество и защита Аллаха.", bn: "আয়াতুল কুরসী — আল্লাহর সার্বভৌমত্ব ও সুরক্ষা।", fa: "آیةالکرسی — حاکمیت و حفاظت الهی.", id: "Ayat al-Kursi — kekuasaan dan perlindungan ilahi.", ms: "Ayat al-Kursi — kekuasaan dan perlindungan ilahi.", tr: "Ayetü'l-Kürsî — ilahi egemenlik ve koruma.", fr: "Ayat al-Kursi — souveraineté et protection divines.", de: "Āyat al-Kursī — göttliche Souveränität und Schutz."}) },
      { surah: 8, verse: 9, surahName: "Al-Anfal", reason: L("“I will reinforce you with a thousand angels.”", { ur: "”میں ہزار فرشتوں سے تمہاری مدد کروں گا۔“", ru: "«Я поддержу вас тысячей ангелов».", bn: "“আমি হাজার ফেরেশতা দিয়ে তোমাদের সাহায্য করব।”", fa: "«شما را با هزار فرشته یاری می‌کنم.»", id: "“Aku akan memperkuatmu dengan seribu malaikat.”", ms: "“Aku akan menguatkan kamu dengan seribu malaikat.”", tr: "“Sizi bin melekle destekleyeceğim.”", fr: "« Je vais vous renforcer de mille anges. »", de: "„Ich werde euch mit tausend Engeln stärken.“" }) },
      { surah: 9, verse: 40, surahName: "At-Tawbah", reason: L("“Do not grieve; indeed Allah is with us.”", { ur: "”غم نہ کرو، بے شک اللہ ہمارے ساتھ ہے۔“", ru: "«Не печалься, поистине Аллах с нами».", bn: "“দুঃখ কোরো না, নিশ্চয়ই আল্লাহ আমাদের সাথে আছেন।”", fa: "«اندوه مدار، خدا با ماست.»", id: "“Janganlah berduka; sesungguhnya Allah bersama kita.”", ms: "“Janganlah berdukacita; sesungguhnya Allah bersama kita.”", tr: "“Üzülme; şüphesiz Allah bizimle beraberdir.”", fr: "« Ne t'attriste pas, Allah est avec nous. »", de: "„Sei nicht traurig; gewiss, Allah ist mit uns.“" }) },
      { surah: 28, verse: 7, surahName: "Al-Qasas", reason: L("“Do not fear, nor grieve. We will return him to you.”", { ur: "”ڈرو نہیں، غم نہ کرو۔ ہم اسے تمہارے پاس واپس لائیں گے۔“", ru: "«Не бойтесь и не печальтесь. Мы вернём его вам».", bn: "“ভয় কোরো না, দুঃখ কোরো না। আমরা তাকে তোমার কাছে ফিরিয়ে দেব।”", fa: "«مترس و اندوهگین مباش، ما او را به تو باز خواهیم گرداند.»", id: "“Janganlah takut dan jangan bersedih; Kami akan mengembalikannya kepadamu.”", ms: "“Janganlah takut dan jangan bersedih; Kami akan kembalikannya kepadamu.”", tr: "“Korkma, üzülme; onu sana geri vereceğiz.”", fr: "« Ne crains rien, ne t'afflige pas. Nous te le rendrons. »", de: "„Fürchte dich nicht und sei nicht traurig; Wir werden ihn dir zurückgeben.“" }) },
    ],
  },
