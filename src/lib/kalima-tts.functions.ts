...
// George — deep, calm, imam-like male voice. Renders Arabic dhikr with a
// solemn, melodious delivery via the multilingual model.
const KALIMA_VOICE_ID = "JBFqnCBsd6RMkjVDRZzb";
...
const KALIMA_VOICE_REV = "v3-george";
